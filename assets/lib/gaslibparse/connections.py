...
class ControlValve(namedtuple('ControlValveNamedTuple',
                              Arc._fields +
                              ('pressure_differential_min',
                               'pressure_differential_max',
                               'flow_threshold',
...
class Valve(namedtuple('ValveNamedTuple',
                       Arc._fields
                       + ('pressure_differential_max',),
                       defaults=(None,) * 1)):
    """
...
class ShortPipe(namedtuple('ShortPipeNamedTuple',
                           Arc._fields)):
    """
...
class Resistor(namedtuple('ResistorNamedTuple',
                          Arc._fields
                          + ('diameter',
                             'drag_factor'),
                          defaults=(None,) * 2)):
